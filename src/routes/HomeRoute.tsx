    ...
    <div className="min-h-page">
      <div className="shadow bg-gradient-to-b from-white to-white dark:bg-gradient-to-b dark:from-gray-900 dark:to-gray-850 rounded-b mb-2">
        <Gallery
          title={
            <p>
              Higgs Boson Portal (HBP)
              <br />a portal for up-to-date categorised articles about the Higgs boson
            </p>
          }
          text="The HBP offers complete information about the latest and historic articles to experts. The categorisation is according to preliminary and published results. Using artifical intelligence, it also offers an automated categorisation for specific production and decay modes of the Higgs boson. The HBP database is updated daily."
