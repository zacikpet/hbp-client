  ...
  return (
    <>
      <div className="flex h-screen bg-cover" style={{ backgroundImage: `url(${Space})` }}>
        ...
        <div
          className={`h-full justify-center items-center ${sidebarOpen ? 'hidden md:flex md:w-full' : 'w-full flex'}`}
        >
      ...
      <div className="flex h-screen bg-cover" style={{ backgroundColor: 'whitesmoke' }}>
        Hello
      </div>
    </>
  )
